...
dashboard.section.buttons.val = {
	dashboard.button("h", "  Recently Used Files", fzf.oldfiles),
	dashboard.button("f", "  Find File", fzf.files),
	dashboard.button("p", "  Find Git File", fzf.git_files),
	dashboard.button("g", "󰊄  Find Text", fzf.live_grep_native),
...
dashboard.section.footer.val = "You Can Rest Now"
